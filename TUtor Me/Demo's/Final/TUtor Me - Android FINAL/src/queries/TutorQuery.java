...
import seniorsoftware.tutorme.Tutors;

public class TutorQuery extends TrinityRestQueryGuts {
	...
	private class StaffHandler extends DefaultHandler{
		...
		throws SAXException {
			...
			if (localName.equals("row")) {
				this.in_row = false;
				field = -1;
				tutor = new TutorObject(id, firstName, lastName, rank, major, email, phone,
						description, availability, major2, major3, major4);
				Tutors.tutors.add(tutor);
			}
		}
