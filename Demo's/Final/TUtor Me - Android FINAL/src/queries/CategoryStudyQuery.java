...
import seniorsoftware.tutorme.CategoryStudy;

public class CategoryStudyQuery extends TrinityRestQueryGuts {
	...
	public void parseXML(BufferedReader input)
		...
		try {
			...
			System.out.println("How many? "+ CategoryStudy.subjects.size());
		} catch (IOException e) {
			e.printStackTrace();
	...
	private class StaffHandler extends DefaultHandler{
		...
		throws SAXException {
			...
			if (localName.equals("row")) {
				...
				CategoryStudy.subjects.add(category);
			}
		}
