...
import seniorsoftware.tutorme.SpringCalendar;

public class SpringCalendarQuery extends TrinityRestQueryGuts {
	...
	public void parseXML(BufferedReader input)
		...
		try {
			...
			System.out.println("How many? "+ SpringCalendar.january.size());
		} catch (IOException e) {
			e.printStackTrace();
		...
		throws SAXException {
			if (localName.equals("row")) {
				...
				if(month.equals("January"))
					SpringCalendar.january.add(new MonthObject(id, begin, end, description));
				if(month.equals("February"))
					SpringCalendar.february.add(new MonthObject(id, begin, end, description));
				if(month.equals("March"))
					SpringCalendar.march.add(new MonthObject(id, begin, end, description));
				if(month.equals("April"))
					SpringCalendar.april.add(new MonthObject(id, begin, end, description));
				if(month.equals("May"))
					SpringCalendar.may.add(new MonthObject(id, begin, end, description));
			}
		}
