...
import seniorsoftware.tutorme.FallCalendar;

public class FallCalendarQuery extends TrinityRestQueryGuts {
	...
	public void parseXML(BufferedReader input)
		...
		try {
			...
			System.out.println("How many? "+ FallCalendar.august.size());
		} catch (IOException e) {
			e.printStackTrace();
		...
		throws SAXException {
			if (localName.equals("row")) {
				...
				if(month.equals("August"))
					FallCalendar.august.add(new MonthObject(id, begin, end, description));
				if(month.equals("September"))
					FallCalendar.september.add(new MonthObject(id, begin, end, description));
				if(month.equals("October"))
					FallCalendar.october.add(new MonthObject(id, begin, end, description));
				if(month.equals("November"))
					FallCalendar.november.add(new MonthObject(id, begin, end, description));
				if(month.equals("December"))
					FallCalendar.december.add(new MonthObject(id, begin, end, description));
			}
		}
