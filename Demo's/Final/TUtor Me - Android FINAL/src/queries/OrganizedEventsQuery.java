...
import seniorsoftware.tutorme.OrganizedEvents;

public class OrganizedEventsQuery extends TrinityRestQueryGuts {
	...
	public void parseXML(BufferedReader input)
		...
		try {
			...
			System.out.println("How many? "+ OrganizedEvents.study.size());
		} catch (IOException e) {
			e.printStackTrace();
	...
	private class StaffHandler extends DefaultHandler{
		...
		throws SAXException {
			...
			if (localName.equals("row")) {
				...
				OrganizedEvents.study.add(events);
			}
		}
