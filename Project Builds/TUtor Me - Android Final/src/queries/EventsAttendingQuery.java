...
import seniorsoftware.tutorme.EventsAttending;

public class EventsAttendingQuery extends TrinityRestQueryGuts {
	...
	public void parseXML(BufferedReader input)
		...
		try {
			...
			System.out.println("How many? "+ EventsAttending.study.size());
		} catch (IOException e) {
			e.printStackTrace();
	...
	private class StaffHandler extends DefaultHandler{
		...
		throws SAXException {
			...
			if (localName.equals("row")) {
				...
				EventsAttending.study.add(events);
			}
		}
